...
-- nkeymap('gw', '<cmd>lua vim.lsp.buf.document_symbol()<CR>')
-- nkeymap('gw', '<cmd>lua vim.lsp.buf.workspace_symbol()<CR>')
-- nkeymap('gr', '<cmd>lua vim.lsp.buf.references()<CR>')
-- nkeymap('gt', '<cmd>lua vim.lsp.buf.type_definition()<CR>')
-- nkeymap('K', '<cmd>lua vim.lsp.buf.hover()<CR>')
-- nkeymap('<c-k>', '<cmd>lua vim.lsp.buf.signature_help()<CR>')
-- nkeymap('<leader>af', '<cmd>lua vim.lsp.buf.code_action()<CR>')
...
local servers = { 'pyright',  'eslint', 'html', 'cssls', 'tailwindcss', 'tsserver', 'jsonls' }
